...
public class ShortTermAccommodationTransformer extends Realestate2PropertyTransformer<ShortTermAccommodation> {

	@Override
	protected Property doTransform(ShortTermAccommodation a, ITransformContext context) {
		// TODO Auto-generated method stub
		return null;
	}
	//
	// private static Logger LOG =
	// Logger.getLogger(ShortTermAccommodationTransformer.class);
	// protected PriceIntervalTypeHelper priceIntervalTypeHelper = new
	// PriceIntervalTypeHelper();
	// protected ShortTermAccomodationTypeHelper shortTermAccomodationTypeHelper
	// = new ShortTermAccomodationTypeHelper();
	//
	// @Override
	// protected Ch__Angebot__c doTransform(ShortTermAccommodation
	// shortTermAccommodation, ITransformContext context) {
	//
	// Ch__Angebot__c angebot = new Ch__Angebot__c();
	// updateRealestateGenericFields(shortTermAccommodation,
	...
	//
	// @Override
	// protected String getImmotypeName(ShortTermAccommodation
