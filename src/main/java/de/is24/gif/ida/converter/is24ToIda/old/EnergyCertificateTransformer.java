...
public class EnergyCertificateTransformer {
	...
	// Logger.getLogger(EnergyCertificateTransformer.class);
	//
	// private final EnergyCertificateAvailabilityHelper
	// energyCertificateAvailabilityHelper = new
	// EnergyCertificateAvailabilityHelper();
	// protected EnergySourceEnev2014Helper energySourceEnev2014Helper = new
	// EnergySourceEnev2014Helper();
	// protected HeatingTypeEnev2014Helper heatingTypeEnev2014Helper = new
	// HeatingTypeEnev2014Helper();
	//
	// public void updateEnergyCertificate(EnergyCertificateFacade facade,
	...
	// }
	//
	// private void preprocessEnevData(EnergyCertificateFacade facade,
	// Ch__Angebot__c angebot) {
	//
	...
	// facade.getEnergyCertificate();
	// BuildingEnergyRatingType buildingEnergyRatingType =
	// facade.getBuildingEnergyRatingType();
	// if (energyCertificate != null && buildingEnergyRatingType != null &&
	// !BuildingEnergyRatingType.NO_INFORMATION.equals(buildingEnergyRatingType))
	// {
	...
	// EnergyCertificateCreationDate energyCertificateCreationDate =
	// energyCertificate.getEnergyCertificateCreationDate();
	//
	...
	// }
	//
	// protected void updateHeatingTypeEnev2014(EnergyCertificateFacade facade,
	// Ch__Angebot__c angebot) {
	// HeatingTypeEnev2014 heatingTypeEnev2014 =
	...
	// }
	//
	// private void updateConstructionYear(EnergyCertificateFacade facade,
	// Ch__Angebot__c angebot) {
	...
	// }
	//
	// private void updateEnergySourceEnev2014(EnergyCertificateFacade facade,
	// Ch__Angebot__c angebot) {
	// EnergySourcesEnev2014 sources = facade.getEnergySourcesEnev2014();
	// if (sources != null) {
	// final Collection<String> mappedSources =
	// energySourceEnev2014Helper.getSalesforceValues(sources.getEnergySourceEnev2014());
	// angebot.setCh__Befeuerungsart__c(StringUtils.join(mappedSources, ";"));
	// }
	// }
	//
	// @SuppressWarnings("incomplete-switch")
	// private void updateThermalCharacteristics(EnergyCertificateFacade facade,
	// Ch__Angebot__c angebot) {
	//
	// EnergyPerformanceCertificate energyCertificate =
	// facade.getEnergyCertificate();
	...
	// }
	//
	// private void updateEnergyPerformanceCertificate(EnergyCertificateFacade
	// facade, Ch__Angebot__c angebot) {
	// EnergyPerformanceCertificate energyCertificate =
	// facade.getEnergyCertificate();
	//
	...
	//
	// updateEnergyCertificateCreationDate(angebot, facade.get(),
	// energyCertificate);
	// }
	// }
	//
	// private void updateEnergyCertificateCreationDate(Ch__Angebot__c angebot,
	// RealEstate realestate, EnergyPerformanceCertificate energyCertificate) {
	// EnergyCertificateCreationDate energyCertificateCreationDate =
	// energyCertificate.getEnergyCertificateCreationDate();
	//
	// if (energyCertificateCreationDate != null) {
	//
	// LOG.info("updating updateEnergyCertificateCreationDate for " +
	// realestate.getId() + " " + energyCertificateCreationDate);
	//
	// if
	// (EnergyCertificateCreationDate.BEFORE_01_MAY_2014.equals(energyCertificateCreationDate))
	// {
	// angebot.setCh__Erstellungsdatum_Energieausweis__c(EnergyCertificateCreationDateHelper.BIS_30_APRIL_2014_EN_EV_2009);
	//
	// LOG.info("Set creation date to 'Bis 30. April 2014 (EnEV 2009)' for" +
	// angebot.getCh__Anbieter_Objekt_Id__c());
	//
	...
	//
	// } else if
	// (EnergyCertificateCreationDate.FROM_01_MAY_2014.equals(energyCertificateCreationDate))
	// {
	// angebot.setCh__Erstellungsdatum_Energieausweis__c(EnergyCertificateCreationDateHelper.AB_01_MAI_2014_EN_EV_2014);
	// LOG.info("Set creation date to 'Ab 01. Mai 2014 (EnEV 2014)' for" +
	// angebot.getCh__Anbieter_Objekt_Id__c());
	// } else {
	// LOG.warn("No valid creation date for" +
	// angebot.getCh__Anbieter_Objekt_Id__c());
	// }
	//
	...
	// }
	//
	// protected void updateBuildingEnergyRatingType(EnergyCertificateFacade
	// facade, Ch__Angebot__c angebot) {
	// BuildingEnergyRatingType buildingEnergyRateType =
	// facade.getBuildingEnergyRatingType();
	//
	...
	//
	// if
	// (buildingEnergyRateType.equals(BuildingEnergyRatingType.ENERGY_CONSUMPTION))
	// {
	// name = "Verbrauchsausweis";
	// } else if
	// (buildingEnergyRateType.equals(BuildingEnergyRatingType.ENERGY_REQUIRED))
	// {
	// name = "Bedarfsausweis";
	// }
	...
	//
	// public void
	// updateEnergyConsumptionContainsWarmWater(EnergyCertificateFacade facade,
	// Ch__Angebot__c angebot) {
	// YesNotApplicableType value =
	// facade.getEnergyConsumptionContainsWarmWater();
