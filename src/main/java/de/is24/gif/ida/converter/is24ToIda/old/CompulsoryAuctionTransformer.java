...
public class CompulsoryAuctionTransformer extends Realestate2PropertyTransformer<CompulsoryAuction> {

	@Override
	protected Property doTransform(CompulsoryAuction a, ITransformContext context) {
		// TODO Auto-generated method stub
		return null;
	}

	// protected CompulsoryAuctionTypeHelper compulsoryAuctionTypeHelper = new
	// CompulsoryAuctionTypeHelper();
	//
	// @Override
	// protected Ch__Angebot__c doTransform(CompulsoryAuction compulsoryAuction,
	// ITransformContext context) {
	//
	// Ch__Angebot__c angebot = new Ch__Angebot__c();
	// updateRealestateGenericFields(compulsoryAuction,
