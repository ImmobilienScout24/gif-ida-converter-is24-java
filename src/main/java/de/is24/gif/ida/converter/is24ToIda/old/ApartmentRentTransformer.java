...
public class ApartmentRentTransformer extends ApartmentTransformer<ApartmentRent> {
	...
	@Override
	protected Property doTransform(ApartmentRent a, ITransformContext context) {
		// TODO Auto-generated method stub
		return null;
	}

	// @Override
	// public Ch__Angebot__c doTransform(ApartmentRent apartmentRent,
	// ITransformContext context) {
	//
	// Ch__Angebot__c angebot = new Ch__Angebot__c();
	// updateRealestateGenericFields(apartmentRent, (SalesforceTransformContext)
	// context, angebot);
	//
	// ApartmentFacade facade =
	// DuckType.coerce(apartmentRent).to(ApartmentFacade.class);
