...
public class GastronomyTransformer extends CommercialTransformer<Gastronomy> {
	...
	@Override
	protected Property doTransform(Gastronomy a, ITransformContext context) {
		// TODO Auto-generated method stub
		return null;
	}
	// protected GastronomyTypeHelper gastronomyTypeHelper = new
	// GastronomyTypeHelper();
	//
	// @Override
	// protected Ch__Angebot__c doTransform(Gastronomy gastronomy,
	// ITransformContext context) {
	//
	// Ch__Angebot__c angebot = new Ch__Angebot__c();
	// updateRealestateGenericFields(gastronomy, (SalesforceTransformContext)
	// context, angebot);
	//
	// CommercialFacade facade =
	// DuckType.coerce(gastronomy).to(CommercialFacade.class);
