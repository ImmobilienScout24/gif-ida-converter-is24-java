 ...
 */
public abstract class SiteTransformer<T extends RealEstate> extends Realestate2PropertyTransformer<T> {
	//
	// protected SiteDevelopmentTypeHelper siteDevelopmentTypeHelper = new
	// SiteDevelopmentTypeHelper();
	// protected SiteConstructibleTypeHelper siteConstructibleTypeHelper = new
	// SiteConstructibleTypeHelper();
	// protected SiteRecommendedUseTypeHelper siteRecommendedUseTypeHelper = new
	...
	// if
	// (CommercializationType.LEASEHOLD.equals(facade.getCommercializationType()))
	// {
