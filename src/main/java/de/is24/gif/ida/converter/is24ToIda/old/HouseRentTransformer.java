...
public class HouseRentTransformer extends HouseTransformer<HouseRent> {
	...
	@Override
	protected Property doTransform(HouseRent a, ITransformContext context) {
		// TODO Auto-generated method stub
		return null;
	}
	// @Override
	// protected Ch__Angebot__c doTransform(HouseRent houseRent,
	// ITransformContext context) {
	//
	// Ch__Angebot__c angebot = new Ch__Angebot__c();
	// updateRealestateGenericFields(houseRent, (SalesforceTransformContext)
	// context, angebot);
	//
