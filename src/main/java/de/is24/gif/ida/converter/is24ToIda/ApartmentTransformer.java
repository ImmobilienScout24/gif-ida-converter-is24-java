...
public abstract class ApartmentTransformer<T extends RealEstate> extends RealestateTransformer<T> {

	protected void updateApartmentFields(ApartmentFacade facade, Ch__Angebot__c angebot) {
