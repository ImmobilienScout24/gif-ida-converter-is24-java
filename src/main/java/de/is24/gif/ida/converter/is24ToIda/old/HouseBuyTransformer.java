...
public class HouseBuyTransformer extends HouseTransformer<HouseBuy> {
	...
	@Override
	protected Property doTransform(HouseBuy a, ITransformContext context) {
		// TODO Auto-generated method stub
		return null;
	}
	// @Override
	// protected Ch__Angebot__c doTransform(HouseBuy houseBuy, ITransformContext
	// context) {
	//
	// Ch__Angebot__c angebot = new Ch__Angebot__c();
	// updateRealestateGenericFields(houseBuy, (SalesforceTransformContext)
	// context, angebot);
	//
