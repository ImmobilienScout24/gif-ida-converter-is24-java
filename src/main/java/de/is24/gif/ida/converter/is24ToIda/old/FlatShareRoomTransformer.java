...
public class FlatShareRoomTransformer extends Realestate2PropertyTransformer<FlatShareRoom> {

	@Override
	protected Property doTransform(FlatShareRoom a, ITransformContext context) {
		// TODO Auto-generated method stub
		return null;
	}
	// protected InternetConnectionTypeHelper internetConnectionTypeHelper = new
	// InternetConnectionTypeHelper();
	// protected SmokingAllowedTypeHelper smokingAllowedTypeHelper = new
	// SmokingAllowedTypeHelper();
	// protected FlatMateGenderTypeHelper flatMateGenderTypeHelper = new
	// FlatMateGenderTypeHelper();
	// protected TVConnectionTypeHelper tvConnectionTypeHelper = new
	// TVConnectionTypeHelper();
	// protected TelephoneConnectionTypeHelper telephoneConnectionTypeHelper =
	// new TelephoneConnectionTypeHelper();
	// protected ParkingSituationTypeHelper parkingSituationTypeHelper = new
	// ParkingSituationTypeHelper();
	//
	// @Override
	// protected Ch__Angebot__c doTransform(FlatShareRoom flatShareRoom,
	// ITransformContext context) {
	//
	// Ch__Angebot__c angebot = new Ch__Angebot__c();
	// updateRealestateGenericFields(flatShareRoom, (SalesforceTransformContext)
	// context, angebot);
	//
