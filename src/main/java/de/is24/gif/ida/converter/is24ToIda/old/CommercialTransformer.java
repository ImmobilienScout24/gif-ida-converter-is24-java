...
public abstract class CommercialTransformer<T extends RealEstate> extends Realestate2PropertyTransformer<T> {
	// protected MarketingTypeHelper marketingTypeHelper = new
	// MarketingTypeHelper();
	//
	// protected void updateCommercialFields(CommercialFacade facade,
