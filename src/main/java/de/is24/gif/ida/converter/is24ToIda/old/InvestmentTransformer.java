...
import de.is24.gif.ida.converter.is24ToIda.helpers.InvestmentTypeHelper;
...
public class InvestmentTransformer extends RealestateTransformer<Investment> {
	protected InvestmentTypeHelper investmentTypeHelper = new InvestmentTypeHelper();
	...
	@Override
	protected Ch__Angebot__c doTransform(Investment investment, ITransformContext context) {

		Ch__Angebot__c angebot = new Ch__Angebot__c();
		updateRealestateGenericFields(investment, (SalesforceTransformContext) context, angebot);
