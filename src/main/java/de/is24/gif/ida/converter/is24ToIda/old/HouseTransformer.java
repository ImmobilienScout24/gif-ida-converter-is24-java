 ...
 */
public abstract class HouseTransformer<T extends RealEstate> extends Realestate2PropertyTransformer<T> {
	//
	// protected void updateHouseFields(HouseFacade facade, Ch__Angebot__c
	// angebot) {
	//
